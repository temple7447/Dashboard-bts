...
const navigate = useNavigate()
  ...
  return (
    <div className='flex flex-row  items-center  justify-between  px-5 py-1 ' style={{backgroundColor:'#769cb6'}}>
    ...
    <Button onClick={()=> navigate('/') } className=' mx-3'> <li className='flex flex-row items-center gap-3'><HiViewBoards  style={{fontSize:20}}/> Dashboard</li></Button>
 <Button  onClick={()=> navigate('/location') }  className=' mx-3' > <li className='flex flex-row items-center gap-3'><HiChartPie  style={{fontSize:20}}/> Elevation Coordinates</li></Button>
 <li>     <About /></li>
