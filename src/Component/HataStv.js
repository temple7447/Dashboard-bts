...
const HataStv = () => {
  ...
  const {useDistace, setdistance, setglobarpathloss, setMute } = useInformation() 
...
const [alertmesuc, setalertmesuc] = useState(false)
  ...
  return (
    <div className="hata-container">
     ...
     <div className="info-text">Transmitter Height = 76.2m, Receiver Height = 1.5 and Frequecy = 583.25Mhz;</div>
